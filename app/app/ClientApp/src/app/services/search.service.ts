...
export class SearchService {
  ...
  searchStockIntraday(queryString: string){
    return this._http.get("https://intraday.worldtradingdata.com/api/v1/intraday?symbol=" + queryString + "&sort=desc&range=1&interval=1&api_token=0TfbCcPV56v84s9bTk3LeNL7GOwu4Wx5UC4wFr3okoOPslKoR91nEhvzzj3Z");
  }
